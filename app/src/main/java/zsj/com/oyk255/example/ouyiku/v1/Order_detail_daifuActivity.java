...
public class Order_detail_daifuActivity extends OykActivity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_order_detail_daifu);
...
//					String address2 = address.getAddress();//区
	...
	private void initUI() {
		...
		mListView = (ScrollViewWithListView) findViewById(R.id.scrollViewWithListView_daifu);

		findViewById(R.id.order_daifu_back).setOnClickListener(this);
...
//				Intent intent = new Intent(Order_detail_daifuActivity.this, DetailActivity.class);
...
//		});
		...
		findViewById(R.id.order_all_fukuan).setOnClickListener(this);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.order_daifu_back:
			finish();
			break;
		case R.id.order_all_fukuan:
			Intent intent = new Intent(Order_detail_daifuActivity.this, PayActivity.class);
		...
		case R.id.order_wuliu_copy:
			...
			clip.setText(text);
			Toast.makeText(Order_detail_daifuActivity.this, "已复制到剪贴板", Toast.LENGTH_SHORT).show();
			break;
		case R.id.tobrand:
			Intent intent4 = new Intent(this, Brand_detailActivity.class);
			intent4.putExtra("mSevenShop1", brandmerchantId);
