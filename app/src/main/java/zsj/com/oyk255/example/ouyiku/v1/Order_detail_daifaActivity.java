...
public class Order_detail_daifaActivity extends OykActivity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_order_detail_daifa);
...
//					Log.e("brandmerchantId", brandmerchantId);
...
//					String address2 = address.getAddress();//区
	...
	private void initUI() {
		...
		mListView = (ScrollViewWithListView) findViewById(R.id.scrollViewWithListView_daifa);
		findViewById(R.id.order_daifa_back).setOnClickListener(this);
...
//				Intent intent = new Intent(Order_detail_daifaActivity.this, DetailActivity.class);
//				intent.putExtra("product_id", productId);
//				startActivity(intent);
//			}
//		});
		findViewById(R.id.order_wuliu_copy).setOnClickListener(this);
		findViewById(R.id.order_all_tixing).setOnClickListener(this);
	...
	public void onClick(View v) {
		...
		case R.id.order_wuliu_copy:
			...
			clip.setText(text);
			Toast.makeText(Order_detail_daifaActivity.this, "已复制到剪贴板", Toast.LENGTH_SHORT).show();
			break;
		case R.id.order_all_tixing:
			Toast.makeText(Order_detail_daifaActivity.this, "提醒成功", Toast.LENGTH_SHORT).show();
			break;
		case R.id.tobrand:
