...
public class Hot_netred_fansActivity extends OykActivity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_hot_netred_fans);
	...
	private void initData() {
    	...
    	progressHUD.show();
		String url= Constant.URL.FANSListUrl+"&user_id="+userid+"&tid="+tid;
		HTTPUtils.get(this, url, new VolleyListener() {
			...
			public void onResponse(String arg0) {
				...
				if(succeed.equals("1")){
					...
					mData.clear();
					mData.addAll(data);
					mListview.setAdapter(new FansNetAdapter());
				}
			}
	...
	private void initUI() {
		findViewById(R.id.fansnet_back).setOnClickListener(this);
		mListview = (ListView) findViewById(R.id.fansnet_listView);
	}
	class FansNetAdapter extends BaseAdapter{
			...
			if(convertView==null){
				...
				holder.mAttent.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						if(userid.equals("")){
							startActivity(new Intent(Hot_netred_fansActivity.this, LoginActivity.class));
						}else{
							
							String anttentUrl="http://a.ouyiku.com/?m=home&c=Talent&a=t_follow"+"&uid="+userid+"&tid="+userId2;
							final ZProgressHUD progressHUD = ZProgressHUD.getInstance(Hot_netred_fansActivity.this); 
							progressHUD.setMessage("加载中");
							progressHUD.setSpinnerType(ZProgressHUD.SIMPLE_ROUND_SPINNER );
							progressHUD.show();
							HTTPUtils.get(Hot_netred_fansActivity.this, anttentUrl, new VolleyListener() {
