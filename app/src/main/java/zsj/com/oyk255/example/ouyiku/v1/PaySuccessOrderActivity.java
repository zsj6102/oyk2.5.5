...
import zsj.com.oyk255.example.ouyiku.v1.Order_detailActivity.AllAdapter;
import zsj.com.oyk255.example.ouyiku.v1.Order_detailActivity.ViewHolder;
...
public class PaySuccessOrderActivity extends OykActivity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_pay_success_order);
	...
	public void onClick(View v) {
		...
		case R.id.order_wuliu_copy:
			...
			clip.setText(text);
			Toast.makeText(PaySuccessOrderActivity.this, "已复制到剪贴板", Toast.LENGTH_SHORT).show();
			break;
		default:
			break;
		}
