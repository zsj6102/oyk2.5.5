 ...
 *
 */
public class Order_daiShouFragment extends Fragment implements OnClickListener{
	private View view;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if(view==null){
			view = inflater.inflate(R.layout.fragment_order_dai_shou, container,
					false);
	...
	private DaishouorderAdapter daishouorderAdapter;
	...
	private void initData() {
    	...
    	progressHUD.show();
		userid = sp.getString("userid", "");
		String DaiFuUrl=Constant.URL.MyOrderURL+"&user_id="+userid+"&status="+3;
			...
			public void onResponse(String arg0) {
				...
				if(succeed.equals("1")){
					...
					if(mData.size()==0){
						...
						mListview.setAdapter(daishouorderAdapter);
					}
				}
			}
	...
	private void initUI() {
		mListview = (ListView) view.findViewById(R.id.order_daishou_listview);
		mImgNull = (ImageView) view.findViewById(R.id.order_daishou_null);
	...
	class DaishouorderAdapter extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if(convertView==null){
				layout=getActivity().getLayoutInflater().inflate(R.layout.order_daishou_item, null);
				...
				holder.order_goods_shouhuo = (TextView) layout.findViewById(R.id.order_goods_shouhuo);
				holder.order_goods_wuliu = (TextView) layout.findViewById(R.id.order_goods_wuliu);
				...
				holder.order_goods_shouhuo.setOnClickListener(new OnClickListener() {
				...
				holder.order_goods_wuliu.setOnClickListener(new OnClickListener() {
	...
	class ViewHolder{
		...
		TextView order_goods_shouhuo;
		TextView order_goods_wuliu;
			...
			new Handler()
			{
				...
				public void handleMessage(Message msg)
				{
					...
					if(mData.size()==0){
						...
						String DaiFuUrl=Constant.URL.MyOrderURL+"&user_id="+userid+"&status="+3+"&num="+size;
						HTTPUtils.get(getActivity(), DaiFuUrl, new VolleyListener() {
							...
							public void onResponse(String arg0) {
								...
								if(succeed.equals("1")){
									...
									mData.addAll(data);
										mImgNull.setVisibility(View.GONE);
										daishouorderAdapter.notifyDataSetChanged();
										pullToRefreshLayout.loadmoreFinish(PullToRefreshLayout.SUCCEED);
								}else{
