...
public class ForgetActivity extends OykActivity implements OnClickListener{
	...
	private void VerifyYZM() {
		...
		HTTPUtils.get(this, VerifyYZMurl, new VolleyListener() {
			...
			public void onResponse(String arg0) {
				...
				if(succeed.equals("1")){
					Intent intent = new Intent(ForgetActivity.this,ChangeSetpassActivity.class);
		...
		HTTPUtils.get(this, ForgetYzmUrl, new VolleyListener() {
			...
			public void onResponse(String arg0) {
				...
				if(succeed.equals("1")){
					...
					if(status2.equals("1")){
						Toast.makeText(ForgetActivity.this, "正在发送验证码", Toast.LENGTH_SHORT).show();
			...
			class TimeCount extends CountDownTimer {
				...
				public void onFinish() {// 计时完毕
					if(RegexValidateUtil.checkMobileNumber(mPhone_et.getText().toString().trim())){
						...
						mSendYZM.setText("获取验证码");
						mSendYZM.setClickable(false);
						Toast.makeText(ForgetActivity.this, "无效的手机号码", Toast.LENGTH_SHORT).show();
					}
				}
